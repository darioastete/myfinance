...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest } from './chunks/_@astrojs-manifest_C9Ltneqj.mjs';
...
const _page2 = () => import('./pages/api/incomes.astro.mjs');
const _page3 = () => import('./pages/api/users.astro.mjs');
const _page4 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/api/expenses.ts", _page1],
    ["src/pages/api/incomes.ts", _page2],
    ["src/pages/api/users.ts", _page3],
...
const _args = {
    "middlewareSecret": "7ef5c6cc-7142-4f64-bd27-4bf47f2d9c84",
